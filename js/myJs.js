const textConfig = {
  ...
  text3: "Em muốn lấy anh có phải không nào ._.",
  text4: "Nếu em ko trả lời mà thoát ra tức là muốn làm vợ anh rùi đó nha :v",
  text5: "Mơ à Cưng???",
  text6: "Về Bảo Mẹ Cưới Luôn<3",
  text7: "lí do Em muốn lấy anh đi :vvvv",
  text8: "Gửi cho Anh <3",
  text9: "Vì Anh đẹp try bụng bự vlllll",
  text10: "Anh biết ngay mà ^^ Yêu em 300.000",
  text11:
    ...
    Swal.fire({
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://zalo.me/0769752906";
          },
        });
      }
    });
